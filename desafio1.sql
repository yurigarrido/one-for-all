...
VALUES ('gratuito', 0.00), ('pessoal', 6.99), ('familiar', 7.99), ('universitário', 5.99);
...
INSERT INTO SpotifyClone.albuns (title, artist_id, release_year)
VALUES
  ('Envious', 1, 1990), ('Exuberant', 1, 1993), ('Hallowed Steam', 2, 1995),
  ('Incandescent', 3, 1998), ('Temporary Culture', 4, 2001), ('Library of liberty', 4, 2003),
  ('Chained Down', 5, 2007), ('Cabinet of fools', 5, 2012), ('No guarantees', 5, 2015), ('Apparatus', 6, 2015);
...
INSERT INTO SpotifyClone.musics (title, album_id, duration)
VALUES 
...
VALUES
  ('Thati', 23, 1, '2019-10-20'), ('Cintia', 35, 3, '2017-12-30'), ('Bill', 20, 4, '2019-06-05'),
  ('Roger', 45, 2, '2020-05-13'), ('Norman', 58, 2, '2017-02-17'), ('Patrick', 33, 3,'2017-01-06'),
  ('Vivian', 26, 4,'2018-01-05'), ('Carol', 19, 4,'2018-02-14'), ('Angelina', 42, 3,'2018-04-29'),
...
INSERT INTO SpotifyClone.play_history (user_id, music_id, reproduction_date)
VALUES
