...
CREATE TABLE albuns (
    ...
    ano_lancamento INT NOT NULL DEFAULT (CURRENT_DATE),
...
CREATE TABLE historico (
    ...
    data_reprodução VARCHAR(50) NOT NULL DEFAULT (CURRENT_DATE),
...
('universitário', 5.99),
('pessoal', 6.99);
INSERT INTO users (name, idade, plano_id, data_assinatura)VALUES
...
INSERT INTO historico (user_id, cancoes_id, data_reprodução)VALUES
